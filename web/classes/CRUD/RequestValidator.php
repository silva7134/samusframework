<?php
require_once 'database/MysqlDataTypes.php';
...
class RequestValidator {
    ...
    private function validate(ReflectionProperty $propertie , $tipo , $docComment="") {
        ...
        if($tipo == MysqlDataTypes::STRING_TYPE) {

            $result = $this->validateString($propertie);

        } elseif($tipo == MysqlDataTypes::NUMERIC_TYPE) {

            $result = $this->validateNumeric($propertie);

        } elseif($tipo == MysqlDataTypes::DATE_TYPE) {

            $result =  $this->validateDate($propertie);

        } elseif($tipo == MysqlDataTypes::VARCHAR_TYPE) {

            $result =  $this->validateVarchar($propertie , $docComment);

        } elseif($tipo == MysqlDataTypes::BOOLEANS_TYPE) {
    ...
    protected function validateDate(ReflectionProperty $prop) {
        ...
        if(DataValidator::validateFormat($value , "9999-99-99" , true)) {
        ...
        } elseif(DataValidator::validateFormat($value , "99-99-9999" , true)) {
