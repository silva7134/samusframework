...
class Type_Array extends ArrayObject {
    ...
    /**
     * Adiciona um ou varios elementos no inicio da Matrix
     * @param $value1 mixed
     * @param $value2...
     * @return Matrix
     */
	...
	/**
	 * Limpa a Matrix desalocando todos os seus dados
	 * @return Matrix
	 */
	...
	/**
	 * Cast de tipo para Matrix
	 * @param $matrix
	 * @return Matrix
	 */
    public static function cast(Matrix $matrix) {
        return $matrix;
    }
